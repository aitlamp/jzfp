...
@Entity
@Table(name = "JZFP_B_XM_ZL", schema = "JZFP", catalog = "")
public class JzfpBXmZlEntity {
    private String zlid;
    private String flid;
    private String zlmc;
    private byte xssx;
    ...
    public boolean equals(Object o) {
        ...
        JzfpBXmZlEntity that = (JzfpBXmZlEntity) o;
        ...
        if (zlmc != null ? !zlmc.equals(that.zlmc) : that.zlmc != null) return false;
    ...
    @Override
    public int hashCode() {
        int result = zlid != null ? zlid.hashCode() : 0;
        result = 31 * result + (flid != null ? flid.hashCode() : 0);
        result = 31 * result + (zlmc != null ? zlmc.hashCode() : 0);

...
@Entity
@Table(name = "JZFP_B_FPGZ_BFDJ", schema = "JZFP", catalog = "")
public class JzfpBFpgzBfdjEntity {
    private String gxid;
    ...
    public void setBfms(String bfms) {
        this.bfms = bfms;
    }
    ...
    public boolean equals(Object o) {
        ...
        JzfpBFpgzBfdjEntity that = (JzfpBFpgzBfdjEntity) o;
        ...
        if (bfms != null ? !bfms.equals(that.bfms) : that.bfms != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (bfms != null ? bfms.hashCode() : 0);
